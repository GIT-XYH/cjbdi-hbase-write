...
public class LoadData {
    public static void main(String[] args) throws Exception {
        ...
        load.doBulkLoad(new Path("hdfs://bd-01:8020/tmp/xyh_test/outHfile1"), admin,table,connection.getRegionLocator(tableName));
        FileSystem fs = FileSystem.get(new URI("hdfs://bd-01:8020"), configuration);
        fs.delete(new Path("/tmp/xyh_test/outHfile1"));
    }
