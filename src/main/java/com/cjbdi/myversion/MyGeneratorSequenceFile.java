 ...
 * @Description: 生成 sequenceFile
 */
public class MyGeneratorSequenceFile {
    //HDFS路径
    String inpath = null;
    String outpath = null;
    ...
    MyGeneratorSequenceFile(String inpath, String outpath) {
        this.inpath = inpath;
...
//        long length = fileSystem.getContentSummary(new Path("hdfs://rookiex01:8020/xyh/pic")).getLength();
    ...
    public static void main(String[] args) throws Exception{
        MyGeneratorSequenceFile sequenceFileTest = new MyGeneratorSequenceFile("/xyh/pic", "/xyh/pic_out");
